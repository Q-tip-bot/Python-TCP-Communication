# The below program utilizes Selective Repeat (Sliding Window Protocol)

# Import libraries for Python networking
import socket
import sys
import threading
import time
...
# Variables for managing and tracking packet info
ExpectedSeqNum = 0
N = 4 # size of window
...
while 1:
      ...
      # If packet received is the base packet
        ...
        # create and send packet to client
        msg = "ACK" + str(SeqNum)
        check = ip_checksum(msg)
        ...
        # Check to see if any other saved data needs to be sent
      ...
      # If packet received is greater than the base and less than window size
