# The following program is a client that utilizes Selective Repeat (Sliding Window Protocol)

# Import python libraries for networking
import socket   
import sys  
import threading
import time
...
# Define variables for packet info
...
# Define timeout function for resending the packet
def Timeout(i):
...
# Determine if you want to manually corrupt a packet
Corrupt = raw_input("Do you want there to be a corrupt packet?(Y or N)")

# Initiate the timer for the first packet
...
while(1):
    ...
    # Package all data up to the window size
